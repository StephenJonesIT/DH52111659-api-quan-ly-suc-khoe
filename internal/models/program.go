...
type Program struct {
	...
	TargetBmiMin 		*float64   	`json:"target_bmi_min,omitempty" gorm:"column:target_bmi_min"`
	TargetBmiMax 		*float64   	`json:"target_bmi_max,omitempty" gorm:"column:target_bmi_max"`	
	TargetConditionID 	*int       	`json:"target_condition_id,omitempty" gorm:"column:target_condition_id"` 
